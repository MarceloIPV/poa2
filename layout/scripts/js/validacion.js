...
var selector__index__principal=function(parametro1,parametro2){
...
estilosFormularios($(".cerrar__seguimientos"));
...
var clasesActivas=function(parametro1,parametro2,parametro3){
	...
	$(parametro1).click(function(e){
		...
		if (parametro3==1) {
			...
			$(".contenedor__general__total").remove();
		}
...
archivoInputObteniendoValor($("#quipux__Suscritos"),$(".clase__quipux__suscrito"),$("#visualiza__quipux__gestion"));
archivoInputObteniendoValor($("#registro__declaracionRecursos"),$(".nombre__declaracionRecursos"),$(".documento__recursosDeclaratorios"));

archivoInputObteniendoValor($("#documentoJustificacion"),$(".nombre__justificacion"),$(".contenedor__pdf__llegados"));
...
ocultarVariables($("#agregarProgramas"),$(".contenedorProgramaTabla"),$(".conjunto__validas"));
ocultarVariables($("#verProgramas"),$(".conjunto__validas"),$(".contenedorProgramaTabla"));


ocultarVariables($("#agregarComponente"),$(".contenedorComponenteTabla"),$(".conjunto__validas"));
ocultarVariables($("#verComponente"),$(".conjunto__validas"),$(".contenedorComponenteTabla"));


ocultarVariables($("#agregarItem"),$(".contenedorItemTabla"),$(".conjunto__validas"));
ocultarVariables($("#verItem"),$(".conjunto__validas"),$(".contenedorItemTabla"));


ocultarVariables($("#agregarEstrategicos"),$(".contenedorObjetivosEsTabla"),$(".conjunto__validas"));
ocultarVariables($("#verEstrategicos"),$(".conjunto__validas"),$(".contenedorObjetivosEsTabla"));

ocultarVariables($("#agregarEncargada"),$(".contenedorEncargadaTabla"),$(".conjunto__validas"));
ocultarVariables($("#verEncargada"),$(".conjunto__validas"),$(".contenedorEncargadaTabla"));

ocultarVariables($("#agregarAccion"),$(".contenedorAccionTabla"),$(".conjunto__validas"));
ocultarVariables($("#verAccion"),$(".conjunto__validas"),$(".contenedorAccionTabla"));

ocultarVariables($("#agregarTipoOrganizacion"),$(".contenedorTipoOrganizacionTabla"),$(".conjunto__validas"));
ocultarVariables($("#verTipoOrganizacion"),$(".conjunto__validas"),$(".contenedorTipoOrganizacionTabla"));

ocultarVariables($("#agregarIndicadores"),$(".contenedorIndicadoresTabla"),$(".conjunto__validas"));
ocultarVariables($("#verIndicadores"),$(".conjunto__validas"),$(".contenedorIndicadoresTabla"));

ocultarVariables($("#agregarRubros"),$(".contenedorRubrosTabla"),$(".conjunto__validas"));
ocultarVariables($("#verRubros"),$(".conjunto__validas"),$(".contenedorRubrosTabla"));

ocultarVariables($("#agregardeporte"),$(".contenedorDeporteTabla"),$(".conjunto__validas"));
ocultarVariables($("#verdeporte"),$(".conjunto__validas"),$(".contenedorDeporteTabla"));

ocultarVariables($("#agregarModalidad"),$(".contenedorModalidadTabla"),$(".conjunto__validas"));
ocultarVariables($("#verModalidad"),$(".conjunto__validas"),$(".contenedorModalidadTabla"));

ocultarVariables($("#agregarPrueba"),$(".contenedorPruebaTabla"),$(".conjunto__validas"));
ocultarVariables($("#verPrueba"),$(".conjunto__validas"),$(".contenedorPruebaTabla"));

ocultarVariables($("#agregarCategoria"),$(".contenedorCategoriaTabla"),$(".conjunto__validas"));
ocultarVariables($("#verCategoria"),$(".conjunto__validas"),$(".contenedorCategoriaTabla"));
