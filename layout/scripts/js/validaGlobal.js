...
$(parametro1).click(function(e){
	...
	e.preventDefault();	
		...
		if (validador==false) {
			...
			let salariosMensualess0=$("#salariosMensualess0").val();
			let aportePatronalMensualess0=$("#aportePatronalMensualess0").val();
			let decimoTercerMensualess0=$("#decimoTercerMensualess0").val();
			let decimoCuartoMensualess0=$("#decimoCuartoMensualess0").val();
			let fondosDeReservaMensualess0=$("#fondosDeReservaMensualess0").val();
			...
			paqueteDeDatos.append("salariosMensualess0",salariosMensualess0);
			paqueteDeDatos.append("aportePatronalMensualess0",aportePatronalMensualess0);
			paqueteDeDatos.append("decimoTercerMensualess0",decimoTercerMensualess0);
			paqueteDeDatos.append("decimoCuartoMensualess0",decimoCuartoMensualess0);
			paqueteDeDatos.append("fondosDeReservaMensualess0",fondosDeReservaMensualess0);
...
var verArmadoMatriz=function(parametro1,parametro2,parametro3){
	...
	$(parametro1).click(function(){
		...
		var tramiteM2023=$(this).attr('tramiteM2023');
		...
		paqueteDeDatos.append('tramiteM2023',tramiteM2023);
		...
		$.ajax({
			...
			success:function(response){
				...
				var tramiteM2023__2=$(parametro1).attr('tramiteM2023');
				...
				if (tipo=="contratacionPublica") {
				...
				}else if (tipo=="administrativas" || tipo=="administrativas__modifica"  || tipo=="administrativas__2023__m") {
				...
				}else if(tipo=="honorarios" || tipo=="honorarios__modifica" || tipo=="honorarios__2023__m"){
				...
				}else if(tipo=="sueldosSalarios" || tipo=="sueldosSalarios__modifica" || tipo=="sueldosSalarios__2023__m"){
					...
					$.getScript("layout/scripts/js/ajax/datatablet.js",function(){
						...
						if (tipo=="sueldosSalarios__2023__m") {

							datatablets($(".sueldos__salarios__realizados"),"sueldos__salarios__realizados__M__2023",[parametro2[1],parametro2[0],tramiteM2023__2],false,false,false,false,false,false);
							datatablets($(".sueldos__salarios__realizados__desvinculaciones"),"sueldos__salarios__realizados__desvinculaciones__M__2023",[parametro2[1],parametro2[0],tramiteM2023__2],false,false,false,false,false,false);
				...
				}else if(tipo=="mantenimiento" || tipo=="mantenimiento__modifica" || tipo=="mantenimiento__2023__m"){
					...
					$.getScript("layout/scripts/js/ajax/datatablet.js",function(){
						...
						if (tipo=="mantenimiento__2023__m") {
							datatablets($(".mantenimiento__tables__realziad"),"mantenimiento__tables__realziad__M__2023",[parametro2[1],parametro2[0],tramiteM2023__2],false,false,false,false,false,false);
						}else{
				...
				}else if(tipo=="actDeportivasIns" || tipo=="actDeportivasIns__modifica" || tipo=="actDeportivasIns__2023__m"){
					...
					// $(parametro3).append('<div  class="table-responsive"><table class="valores__adicionales" id="valores__adicionalesAct"><thead><tr><th align="center">ITEM</th><th align="center">Tipo<br>financiamiento</th><th align="center">Nombre<br>evento</th><th>Deporte</th><th>Provincia</th><th>Sede<br>Ciudad<br>País</th><th>Alcance</th><th>Fecha<br>inicio</th><th>Fecha<br>fin</th><th>Género</th><th>Categoría</th><th>No.<br>Entrenadores<br>oficiales</th><th>No.<br>atletas</th><th>Total</th><th>Mujeres<br>(Beneficiarios)</th><th>Hombres<br>(Beneficiarios)</th><th>Detalle lo que<br>el organismo<br>va a adquirir</th><th>Justificación<br>de la adquisición<br>del bien<br>o servicio</th><th>Cantidad<br>del bien<br>o servicio<br>a adquirir</th><th>Enero</th><th>Febrero</th><th>Marzo</th><th>Abril</th><th>Mayo</th><th>Junio</th><th>Julio</th><th>Agosto</th><th>Septiembre</th><th>Octubre</th><th>Noviembre</th><th>Diciembre</th><th>Total</th></tr></thead></table></div>');
						...
						$.getScript("layout/scripts/js/ajax/datatablet.js",function(){
							...
							if (tipo=="actDeportivasIns__2023__m") {
								datatablets($("#valores__adicionalesAct"),"valores__adicionalesAct__m__2023",[parametro2[1],parametro2[0],tramiteM2023__2],false,-1,false,false,false,false);
							}else{
				...
				for (c of informacionSeleccionada) {
					...
					if (tipo=="administrativas" || tipo=="administrativas__modifica" || tipo=="administrativas__2023__m") {
...
var verOjoAjaxMatrices=function(parametro1,parametro2,parametro3,parametro4,parametro5,parametro6,parametro7,parametro8,parametro9,parametro10){
				...
				success:function(response){
					...
					if (mensajeActividad=="actDeportivas") {
						...
						if(parametro9==true){
							...
							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-6 text-center" attr="'+parametro4+'" matriz="actDeportivasIns__2023__m" tramiteM2023="'+parametro10+'">ACTIVIDADES DEL FOMENTO DEPORTIVA, EDUCACIÓN FÍSICA Y RECREACIÓN</a><br><br>');

						}else if (parametro8==true) {

							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-3 text-center" attr="'+parametro4+'" matriz="actDeportivasIns">ACTIVIDADES DEL FOMENTO DEPORTIVA, EDUCACIÓN FÍSICA Y RECREACIÓN</a><a style="cursor:pointer!important;color:#0d47a1!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-3 text-center" attr="'+parametro4+'" matriz="actDeportivasIns__modifica" tramiteM2023="'+false+'">ACTIVIDADES DEL FOMENTO DEPORTIVA, EDUCACIÓN FÍSICA Y RECREACIÓN</a><br><br>');

						}else{

							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-6 text-center" attr="'+parametro4+'" matriz="actDeportivasIns" tramiteM2023="'+false+'">ACTIVIDADES DEL FOMENTO DEPORTIVA, EDUCACIÓN FÍSICA Y RECREACIÓN</a><br><br>');
					...
					if(mensajeActividad=="sueldos__salarios"){
						...
						if(parametro9==true){
							...
							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-6 text-center" attr="'+parametro4+'" matriz="sueldosSalarios__2023__m" tramiteM2023="'+parametro10+'">SUELDOS Y SALARIOS</a><br><br>');

						}else if (parametro8==true) {

							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-3 text-center" attr="'+parametro4+'" matriz="sueldosSalarios">SUELDOS Y SALARIOS</a><a style="cursor:pointer!important;color:#0d47a1!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-3 text-center" attr="'+parametro4+'" matriz="sueldosSalarios__modifica" tramiteM2023="'+false+'">SUELDOS Y SALARIOS (MODIFICACIÓN)</a><br><br>');

						}else{

							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-6 text-center" attr="'+parametro4+'" matriz="sueldosSalarios" tramiteM2023="'+false+'">SUELDOS Y SALARIOS</a><br><br>');
					...
					if(mensajeActividad=="mantenimiento"){
						...
						if(parametro9==true){
							...
							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-6 text-center" attr="'+parametro4+'" matriz="mantenimiento__2023__m" tramiteM2023="'+parametro10+'">MANTENIMIENTO</a><br><br>');

						}else if (parametro8==true) {

							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-3 text-center" attr="'+parametro4+'" matriz="mantenimiento">MANTENIMIENTO</a><a style="cursor:pointer!important;color:#0d47a1!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-3 text-center" attr="'+parametro4+'" matriz="mantenimiento__modifica" tramiteM2023="'+false+'">MANTENIMIENTO (MODIFICACIÓN)</a><br><br>');

						}else{

							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-6 text-center" attr="'+parametro4+'" matriz="mantenimiento" tramiteM2023="'+false+'">MANTENIMIENTO</a><br><br>');
					...
					if (mensajeActividadH=="honorarios") {
						...
						if(parametro9==true){
							...
							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-6 text-center" attr="'+parametro4+'" matriz="honorarios__2023__m" tramiteM2023="'+parametro10+'">HONORARIOS PROFESIONALES</a><br><br>');

						}else if (parametro8==true) {

							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-3 text-center" attr="'+parametro4+'" matriz="honorarios">HONORARIOS PROFESIONALES</a><a style="cursor:pointer!important;color:#0d47a1!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-3 text-center" attr="'+parametro4+'" matriz="honorarios__modifica" tramiteM2023="'+false+'">HONORARIOS PROFESIONALES (MODIFICACIÓN)</a><br><br>');

						}else{

							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-6 text-center" attr="'+parametro4+'" matriz="honorarios" tramiteM2023="'+false+'">HONORARIOS PROFESIONALES</a><br><br>');
					...
					if (mensajeAdministrativas=="administrativas") {
						...
						if(parametro9==true){
							...
							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-6 text-center" attr="'+parametro4+'" matriz="administrativas__2023__m" tramiteM2023="'+parametro10+'">ACTIVIDADES ADMINISTATIVAS</a><br><br>');

						}else if (parametro8==true) {

							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-3 text-center" attr="'+parametro4+'" matriz="administrativas">ACTIVIDADES ADMINISTATIVAS</a><a style="cursor:pointer!important;color:#0d47a1!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-3 text-center" attr="'+parametro4+'" matriz="administrativas__modifica" tramiteM2023="'+false+'">ACTIVIDADES ADMINISTATIVAS (MODIFICACIÓN)</a><br><br>');

						}else{

							$(parametro3).append('<a style="cursor:pointer!important;" data-bs-toggle="modal" data-bs-target="#modalVisualizaMatrices" class="visualiza__'+parametro4+' col col-6 text-center" attr="'+parametro4+'" matriz="administrativas" tramiteM2023="'+false+'">ACTIVIDADES ADMINISTATIVAS</a><br><br>');
...
var enviar__eventos__totales__doceavos__modificaciones__dos=function(parametro1,parametro2,parametro3){
				...
				$.ajax({
					...
					success:function(response){
						...
						$.ajax({
							...
							data: { idOrganismo: $("#idOrganismoPrincipal").val(), idActividad: $("#actividad__modificaciones__destino__modificaciones2__seleccion").val(), indicador: indicador, validador: validador, actividadOrigen: actividadOrigen },
							dataType: 'html',
							type: 'POST',
							url: 'modelosBd/validaciones/selector.modelo.php'
							...
							if (listar__lugar!=undefined && listar__lugar!=null && listar__lugar!="" && listar__lugar!=" ") {
								$("#eventos_intervencion__seleccion").html(listar__lugar);
...
var agregar__en__contenedores__modificaciones__1=function(parametro1,parametro5,parametro3,parametro4){
	...
	confirm.set('onok', function(){ //callbak al pulsar botón positivo
		...
		if (!$("#enero"+array[0]).length > 0 ) {
			...
			if (parametro3==false) {
				...
				$(".contenedor__tables__r__2").append('<form id="formMatrizEven'+array[0]+'" class="formMatrizEven'+array[0]+' total__enlazados__items__'+array[0]+'"><table class="total__enlazados__items__'+array[0]+'"><tr class="total__enlazados__items__'+array[0]+'"><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Ítem</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A; background:white!important;">Enero</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Febrero</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Marzo</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Abril</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Mayo</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Junio</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Julio</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Agosto</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Septiembre</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Octubre</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Noviembre</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Diciembre</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Total</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Guardar</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Eliminar</center></td></tr><tr class="total__enlazados__items__'+array[0]+'"><td><input type="hidden" class="ancho__total__input enlazados__items__sin enlazados__items__'+array[0]+' total__enlazados__items__'+array[0]+'" value="'+array[0]+'"/><input type="text" class="ancho__total__input total__enlazados__items__'+array[0]+'" value="'+array[1]+'" style="border:none!important;" disabled=""/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f enero'+array[0]+'" name="enero'+array[0]+'" id="enero'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="enero__2'+array[0]+'" name="enero__2'+array[0]+'" id="enero__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f febrero'+array[0]+'" name="febrero'+array[0]+'" id="febrero'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="febrero__2'+array[0]+'" name="febrero__2'+array[0]+'" id="febrero__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f marzo'+array[0]+'" name="marzo'+array[0]+'" id="marzo'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="marzo__2'+array[0]+'" name="marzo__2'+array[0]+'" id="marzo__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f abril'+array[0]+'" name="abril'+array[0]+'" id="abril'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="abril__2'+array[0]+'" name="abril__2'+array[0]+'" id="abril__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f mayo'+array[0]+'" name="mayo'+array[0]+'" id="mayo'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="mayo__2'+array[0]+'" name="mayo__2'+array[0]+'" id="mayo__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f junio'+array[0]+'" name="junio'+array[0]+'" id="junio'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="junio__2'+array[0]+'" name="junio__2'+array[0]+'" id="junio__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f julio'+array[0]+'" name="julio'+array[0]+'" id="julio'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="julio__2'+array[0]+'" name="julio__2'+array[0]+'" id="julio__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f agosto'+array[0]+'" name="agosto'+array[0]+'" id="agosto'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="agosto__2'+array[0]+'" name="agosto__2'+array[0]+'" id="agosto__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f septiembre'+array[0]+'" name="septiembre'+array[0]+'" id="septiembre'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="septiembre__2'+array[0]+'" name="septiembre__2'+array[0]+'" id="septiembre__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f octubre'+array[0]+'" name="octubre'+array[0]+'" id="octubre'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="octubre__2'+array[0]+'" name="octubre__2'+array[0]+'" id="octubre__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f noviembre'+array[0]+'" name="noviembre'+array[0]+'" id="noviembre'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="noviembre__2'+array[0]+'" name="noviembre__2'+array[0]+'" id="noviembre__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f diciembre'+array[0]+'" name="diciembre'+array[0]+'" id="diciembre'+array[0]+'" value="0" readonly="readonly"/><input type="hidden" class="diciembre__2'+array[0]+'" name="diciembre__2'+array[0]+'" id="diciembre__2'+array[0]+'" value="0"/></td><td><input type="text" readonly=""  class="ancho__total__input totalSumatoriasMontos'+array[0]+'" name="totalSumatoriasMontos'+array[0]+'" id="totalSumatoriasMontos'+array[0]+'" value="0"/></td><td><a type="button" class="btn btn-info pointer__botones total__enlazados__items__'+array[0]+' guardantes__'+array[0]+'" id="guardantes__'+array[0]+'" attr="'+array[0]+'"><i class="fa fa-floppy-o" aria-hidden="true"></i></a></td><td><a type="button" class="btn btn-danger pointer__botones total__enlazados__items__'+array[0]+' eliminates__'+array[0]+'" id="eliminates__'+array[0]+'" attr="'+array[0]+'"><i class="fa fa-trash" aria-hidden="true"></i></a></td></tr></table></form>');


			}else{

				$(".contenedor__tables__r__2").append('<form id="formMatrizEven'+array[0]+'" class="formMatrizEven'+array[0]+' total__enlazados__items__'+array[0]+'"><table class="total__enlazados__items__'+array[0]+'"><tr class="total__enlazados__items__'+array[0]+'"><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Ítem</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A; background:white!important;">Enero</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Febrero</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Marzo</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Abril</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Mayo</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Junio</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Julio</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Agosto</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Septiembre</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Octubre</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Noviembre</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Diciembre</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Total</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Tipo de Contratación (Campo obligatorio para ingresar la información)</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Guardar</center></td><td style="text-align:right; vertical-align:middle; font-size:12px!important; color:#5A5A5A;"><center>Eliminar</center></td></tr><tr class="total__enlazados__items__'+array[0]+'"><td><input type="hidden" class="ancho__total__input enlazados__items__sin enlazados__items__'+array[0]+' total__enlazados__items__'+array[0]+'" value="'+array[0]+'"/><input type="text" class="ancho__total__input total__enlazados__items__'+array[0]+'" value="'+array[1]+'" style="border:none!important;" disabled=""/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f enero'+array[0]+'" name="enero'+array[0]+'" id="enero'+array[0]+'" value="0"/><input type="hidden" class="enero__2'+array[0]+'" name="enero__2'+array[0]+'" id="enero__2'+array[0]+'" value="0" readonly=""/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f febrero'+array[0]+'" name="febrero'+array[0]+'" id="febrero'+array[0]+'" value="0" readonly=""/><input type="hidden" class="febrero__2'+array[0]+'" name="febrero__2'+array[0]+'" id="febrero__2'+array[0]+'" value="0" readonly=""/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f marzo'+array[0]+'" name="marzo'+array[0]+'" id="marzo'+array[0]+'" value="0" readonly=""/><input type="hidden" class="marzo__2'+array[0]+'" name="marzo__2'+array[0]+'" id="marzo__2'+array[0]+'" value="0" readonly=""/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f abril'+array[0]+'" name="abril'+array[0]+'" id="abril'+array[0]+'" value="0" readonly=""/><input type="hidden" class="abril__2'+array[0]+'" name="abril__2'+array[0]+'" id="abril__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f mayo'+array[0]+'" name="mayo'+array[0]+'" id="mayo'+array[0]+'" value="0" readonly=""/><input type="hidden" class="mayo__2'+array[0]+'" name="mayo__2'+array[0]+'" id="mayo__2'+array[0]+'" value="0" readonly=""/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f junio'+array[0]+'" name="junio'+array[0]+'" id="junio'+array[0]+'" value="0"/><input type="hidden" class="junio__2'+array[0]+'" name="junio__2'+array[0]+'" id="junio__2'+array[0]+'" value="0" readonly=""/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f julio'+array[0]+'" name="julio'+array[0]+'" id="julio'+array[0]+'" value="0" readonly=""/><input type="hidden" class="julio__2'+array[0]+'" name="julio__2'+array[0]+'" id="julio__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f agosto'+array[0]+'" name="agosto'+array[0]+'" id="agosto'+array[0]+'" value="0" readonly=""/><input type="hidden" class="agosto__2'+array[0]+'" name="agosto__2'+array[0]+'" id="agosto__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f septiembre'+array[0]+'" name="septiembre'+array[0]+'" id="septiembre'+array[0]+'" value="0" readonly=""/><input type="hidden" class="septiembre__2'+array[0]+'" name="septiembre__2'+array[0]+'" id="septiembre__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f octubre'+array[0]+'" name="octubre'+array[0]+'" id="octubre'+array[0]+'" value="0" readonly=""/><input type="hidden" class="octubre__2'+array[0]+'" name="octubre__2'+array[0]+'" id="octubre__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f noviembre'+array[0]+'" name="noviembre'+array[0]+'" id="noviembre'+array[0]+'" value="0" readonly=""/><input type="hidden" class="noviembre__2'+array[0]+'" name="noviembre__2'+array[0]+'" id="noviembre__2'+array[0]+'" value="0"/></td><td><input type="text" class="ancho__total__input solo__numero__montos enlazados__sumas__de'+array[0]+' cambio__de__numero__f diciembre'+array[0]+'" name="diciembre'+array[0]+'" id="diciembre'+array[0]+'" value="0" readonly=""/><input type="hidden" class="diciembre__2'+array[0]+'" name="diciembre__2'+array[0]+'" id="diciembre__2'+array[0]+'" value="0"/></td><td><input type="text" readonly=""  class="ancho__total__input totalSumatoriasMontos'+array[0]+'" name="totalSumatoriasMontos'+array[0]+'" id="totalSumatoriasMontos'+array[0]+'" value="0"/></td><td><center><a class="btn btn-primary tipoContratacion__Guardar__3'+array[0]+'" data-bs-toggle="modal" data-bs-target="#contrataciones__variables__3" id="tipoContratacion__Guardar__3" attr="'+array[0]+'">Contratación</a></center></td><td><a type="button" class="btn btn-info pointer__botones total__enlazados__items__'+array[0]+' guardantes__'+array[0]+'" id="guardantes__'+array[0]+'" attr="'+array[0]+'"><i class="fa fa-floppy-o" aria-hidden="true"></i></a></td><td><a type="button" class="btn btn-danger pointer__botones total__enlazados__items__'+array[0]+' eliminates__'+array[0]+'" id="eliminates__'+array[0]+'" attr="'+array[0]+'"><i class="fa fa-trash" aria-hidden="true"></i></a></td></tr></table></form>');
		...
		if (parametro3==false) {
			...
			enviar__eventos__totales__items__montos($(".guardantes__"+array[0]),"guardar__eventos__inicial__montos__3__modificaciones__1","formMatrizEven"+array[0],array[0],array[0],parametro5,parametro3,parametro4);

		}else{

			enviar__eventos__totales__items__montos($(".guardantes__"+array[0]),"guardar__eventos__inicial__montos__3__modificaciones__1","formMatrizEven"+array[0],array[0],array[0],parametro5,parametro3);
