...
var actividades__selector__modificaciones__destino = function (parametro1, parametro2,parametro3) {
	...
	$.ajax({
		...
		data: { indicador: indicador, idOrganismo: parametro2,identificadorPaginaReal:identificadorPaginaReal },
		dataType: 'html',
		type: 'POST',
		url: 'modelosBd/validaciones/selector.modelo.php'
		...
		if (parametro3=="honorarios") {
			$(parametro1).html(listar__lugar);
			$(parametro1).append("<option value='sueldosD'>4.-OPERACIÓN DEPORTIVA (SUELDOS Y SALARIOS)</option>");
			$(parametro1).append("<option value='desvinculacionOrigen'>4.-OPERACIÓN DEPORTIVA (DESVINCULACIÓN ORÍGEN)</option>");
		}else if(parametro3=="sueldos"){
			$(parametro1).html(listar__lugar);
			$(parametro1).append("<option value='honorariosD'>4.-OPERACIÓN DEPORTIVA (HONORARIOS)</option>");
			// $(parametro1).append("<option value='desvinculacionOrigen'>4.-OPERACIÓN DEPORTIVA (DESVINCULACIÓN ORÍGEN)</option>");
		}else if(parametro3=="origenDesvinculacion"){
			$(parametro1).html(listar__lugar);
			$(parametro1).append("<option value='sueldosD'>4.-OPERACIÓN DEPORTIVA (SUELDOS Y SALARIOS)</option>");
			$(parametro1).append("<option value='honorariosD'>4.-OPERACIÓN DEPORTIVA (HONORARIOS)</option>");
			// $(parametro1).append("<option value='desvinculacionD'>4.-OPERACIÓN DEPORTIVA (DESVINCULACIÓN)</option>");
			$(parametro1).append("<option value='desvinculacionOrigen'>4.-OPERACIÓN DEPORTIVA (DESVINCULACIÓN ORÍGEN)</option>");
			$("#actividad__modificaciones__destino__modificaciones2__seleccion option[value=4]").remove();
			$("#actividad__modificaciones__destino__modificaciones2__seleccion option[value=desvinculacionD]").remove();
		}else{
			$(parametro1).html(listar__lugar);
			$(parametro1).append("<option value='sueldosD'>4.-OPERACIÓN DEPORTIVA (SUELDOS Y SALARIOS)</option>");
			$(parametro1).append("<option value='honorariosD'>4.-OPERACIÓN DEPORTIVA (HONORARIOS)</option>");
			$(parametro1).append("<option value='desvinculacionOrigen'>4.-OPERACIÓN DEPORTIVA (DESVINCULACIÓN)</option>");
		}
...
$(selector).change(function () {
	...
	if ($("#actividad__modificaciones").val()==2) {
		...
		let actividadOrigenes=$("#actividad__modificaciones__destino__modificaciones2_o").val();
		let actividadDestinos=$("#actividad__modificaciones__destino__modificaciones2__seleccion").val();


		indicador = 1010;
		$.ajax({
			data: { idOrganismo: idOrganismo, idActividad: $("#actividad__modificaciones").val(), indicador: indicador,nombreInfras:$(this).val(),actividadOrigenes:actividadOrigenes,actividadDestinos:actividadDestinos},
			dataType: 'html',
			type: 'POST',
			url: 'modelosBd/validaciones/selector.modelo.php'
		}).done(function (listar__lugar) {
...
$(selector).change(function () {
	...
	if ($("#actividad__modificaciones__destinos").val()=="desvinculacionOrigen") {
	...
	if (((($("#actividad__modificaciones__destinos").val()==4 && comparador=="sueldos")  || $("#actividad__modificaciones__destinos").val()=="sueldosD") && ($("#identificadorPaginaReal").val()=="honorarios" || $("#identificadorPaginaReal").val()=="sueldos" || $("#identificadorPaginaReal").val()=="diferentes" || $("#identificadorPaginaReal").val()=="origenDesvinculacion")) && $("#actividad__modificaciones__destinos").val()!=2) {

		let textos=$('#eventos_intervencion__seleccion option:selected').text();

		$(".ocultar__fila__eventos__dos__honorarios").hide();
		...
		if(textos=="vacante" || textos=="VACANTE"){
			...
			$.getScript("layout/scripts/js/modificacion/modificacionEdicionInsercion.js",function(){
				...
				segmentosJsAjax($(".body__actividadesEs__modificaciones__insertar"),"actividadesPoas__modificaciones",4,"sueldos","crear",$(selector).val());
	...
	if (((($("#actividad__modificaciones__destinos").val()==4 && comparador=="honorarios")  || $("#actividad__modificaciones__destinos").val()=="honorariosD") && ($("#identificadorPaginaReal").val()=="honorarios" || $("#identificadorPaginaReal").val()=="sueldos") || ($("#identificadorPaginaReal").val()=="diferentes" && $("#actividad__modificaciones__destinos").val() || $("#identificadorPaginaReal").val()=="origenDesvinculacion")) && $("#actividad__modificaciones__destinos").val()!=2) {

		$(".ocultar__fila__eventos__dos__honorarios").show();
		...
		if(textos=="vacante" || textos=="VACANTE"){
			...
			var paqueteDeDatos = new FormData();
			let envioHonorarios=$(this).val();

			paqueteDeDatos.append('tipo','llamarHonorarios');
			paqueteDeDatos.append('envioHonorarios',envioHonorarios);
			...
			$.ajax({
				...
				success:function(response){
					...
					var elementos=JSON.parse(response);
					var informacioInicial=elementos['informacioInicial'];

					for(x of informacioInicial){

						$("#cedulaHonorariosSuscritos").val(x.cedula);
						$("#cargoHonorariosSuscritos").val(x.cargo);
						$("#tipoCargoHonorariosSuscritos").val(x.tipoCargo);
			...
			$.getScript("layout/scripts/js/modificacion/modificacionEdicionInsercion.js",function(){
				...
				segmentosJsAjax($(".body__actividadesEs__modificaciones__insertar"),"actividadesPoas__modificaciones",4,"honorarios","crear",$(selector).val());
	...
	if ($("#actividad__modificaciones__destinos").val()==2) {
		...
		if ($(this).val()=="eventoCrear") {
			...
			indicador = 1010;
			$.ajax({
				data: { idOrganismo: idOrganismo, idActividad: $("#actividad__modificaciones__destinos").val(), indicador: indicador,nombreInfras:$(this).val(),actividadOrigenes:actividadOrigenes,actividadDestinos:actividadDestinos},
				dataType: 'html',
				type: 'POST',
				url: 'modelosBd/validaciones/selector.modelo.php'
			}).done(function (listar__lugar) {
	...
	if ($("#actividad__modificaciones__destinos").val()==3  || $("#actividad__modificaciones__destinos").val()==5 || $("#actividad__modificaciones__destinos").val()==6 || $("#actividad__modificaciones__destinos").val()==7 || ($("#actividad__modificaciones__destinos").val()==4 && $("#identificadorPaginaReal").val()=="diferentes")) {
		...
		if ($(this).val()=="eventoCrear") {
			...
			let actividadOrigenes=0;
		
			if ($("#identificadorPaginaReal").val()=="honorarios" || $("#identificadorPaginaReal").val()=="sueldos") {
				actividadOrigenes=4;
			}else{
				actividadOrigenes=$("#actividad__modificaciones__destino__modificaciones2_o").val();
			}
...
$(selector).change(function () {
	...
	$.ajax({
		...
		data: {idOrganismo: idOrganismo, indicador: indicador, item:$(this).val(),idActividad:$("#actividad__modificaciones__destino__modificaciones2_o").val(),eventos_intervencion_o:$("#eventos_intervencion_o").val()},
		dataType: 'html',
		type: 'POST',
		url: 'modelosBd/validaciones/selector.modelo.php'
	...
	let idActividadOrigenes=$("#actividad__modificaciones__destino__modificaciones2_o").val();

	paqueteDeDatos.append('tipo','bloqueos__actividades');
	paqueteDeDatos.append('idActividadOrigenes',idActividadOrigenes);
...
$(selector).change(function () {
	...
	if ((parametro4=="honorarios" || parametro4=="sueldos") && ($("#actividad__modificaciones__destino__modificaciones2__seleccion").val()=="4" || $("#actividad__modificaciones__destino__modificaciones2__seleccion").val()=="honorariosD" || $("#actividad__modificaciones__destino__modificaciones2__seleccion").val()=="sueldosD") || ($("#identificadorPaginaReal").val()=="diferentes" && $("#actividad__modificaciones__destino__modificaciones2__seleccion").val()=="honorariosD")) {
		...
		let item__modificaciones__destino__modificaciones2__seleccion=$("#item__modificaciones__destino__modificaciones2__seleccion").val();

		$.ajax({

			data: {idOrganismo: idOrganismo, indicador: indicador, item:$(this).val(),idActividad:$("#actividad__modificaciones__destinos").val(),eventos_intervencion_o:$("#eventos_intervencion__seleccion").val(),item__modificaciones__destino__modificaciones2__seleccion:item__modificaciones__destino__modificaciones2__seleccion},
			dataType: 'html',
			type: 'POST',
			url: 'modelosBd/validaciones/selector.modelo.php'
...
$(parametro1).change(function () {
	...
	if ((idActividad == 3 || idActividad == 4 || idActividad == 5 || idActividad == 6 || idActividad == 7) && $("#identificadorPaginaReal").val()!="honorarios" && $("#identificadorPaginaReal").val()!="sueldos") {
...
$(parametro1).change(function () {
	...
	if ($(this).val()=="desvinculacionD") {

		$(".oculto__desvinculacion__o__mostrar").show();
		$(".oculto__desvinculacion__o").hide();

	}else{

		$(".oculto__desvinculacion__o").show();
		$(".oculto__desvinculacion__o__mostrar").hide();

	}


	if ((idActividad == 3 || idActividad == 5 || idActividad == 6 || idActividad == 7) || (idActividad == 4 && $("#identificadorPaginaReal").val()=="diferentes")) {
	...
	if(idActividad == "sueldosD" || idActividad == "desvinculacionOrigen"){
		...
		actividadOrigen = $("#actividad__modificaciones__destinos").val();
		$.ajax({
			data: { idOrganismo: parametro3, idActividad: idActividad, indicador: indicador, validador: validador, actividadOrigen: actividadOrigen,identificadorPaginaReal:identificadorPaginaReal },
			dataType: 'html',
			type: 'POST',
			url: 'modelosBd/validaciones/selector.modelo.php'
		}).done(function (listar__lugar) {
	...
	if (idActividad == 1) {
		...
		$.ajax({
			...
			data: { idOrganismo: parametro3, idActividad: idActividad, indicador: indicador, validador: validador, actividadOrigen: actividadOrigen,actividadOrigenes:actividadOrigenes,actividadDestinos:actividadDestinos},
			dataType: 'html',
			type: 'POST',
			url: 'modelosBd/validaciones/selector.modelo.php'
