<!DOCTYPE html>
	...
	<html lang="es">
		...
		<script type="text/javascript" src="layout/scripts/js/validacionBasica.js?v=1.0.14"></script>

		<!-- selector validaciones -->
		<script type="text/javascript" src="layout/scripts/js/validacionSelector.js?v=1.0.9"></script>
