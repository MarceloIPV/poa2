...
<div class="content-wrapper">
	...
	<section class="content row d d-flex justify-content-center">
		...
		<?= $componentes->getComponentes(1, "ASIGNACIÓN DE DECREMENTO"); ?>
			...
			<table id="asignarPresupuestoMo__incrementos__v__1" class="col col-12 cell-border">
				...
				<thead>
					...
					<tr>
						...
						<th>
							<center>Monto Decremento</center>
						</th>
						<th>
...
<?= $componentes__indicadores->getModalEnvioOD("modalEnvioOD", "Envio Notificación", "Decremento"); ?>

<?= $componentes__indicadores->getModalAtributosPdfs("modalAsignarPre", "Decremento del presupuesto", "-", "decremento", $idUsuarioEn); ?>


<!--====  End of Modales  ====-->

<script type="text/javascript">
	restarDecrementos($("#montoIngresadoModificacion__incrementos"), $("#montoTotal__Modificacion__incrementos"), $("#total__Incrementos"), $("#total__Incrementos_M_"));
</script>
