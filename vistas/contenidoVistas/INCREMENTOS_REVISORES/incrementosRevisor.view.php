...
<div class="content-wrapper">
	...
	<section class="content row d d-flex justify-content-center">
		...
		<?=$componentes->getComponentes(1,"TRÁMITES INCREMENTOS");?>

		<div class="row">

		<br>

		<table id="reasignacion__Incremento" class="col col-12 cell-border">
		...
		<input type="hidden" name="identificadorPaginaRevisor" id="identificadorPaginaRevisor" value="Reasignado">
...
<script type="text/javascript" src="layout/scripts/js/incrementosDecrementos/index.js?v=1.0.9"></script>
