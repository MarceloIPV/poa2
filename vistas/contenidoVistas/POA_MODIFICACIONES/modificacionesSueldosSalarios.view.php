...
<input type="hidden" id="identificadorPaginaReal" name="identificadorPaginaReal" value="sueldos" />
...
<section class='content row mt-1 oculto__tabla__destino__salarios' style="width:100%; overflow-y: scroll;">
