...
<div class="content-wrapper d d-flex flex-column align-items-center">
	...
	<section class="content row d d-flex justify-content-left align-items-center mt-4"> 
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
						
				<a class="btn btn-info" href="excelD/POA.xlsx"><i class="fa fa-file-excel-o" aria-hidden="true"></i></a>

				<select id="semestrePoaGeneral" name="semestrePoaGeneral">
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreIndicadores" name="semestreIndicadores">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreSuministros" name="semestreSuministros">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreSueldosSalarios" name="semestreSueldosSalarios">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>				
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreDesvinculaciones" name="semestreDesvinculaciones">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>		
			...
			<div class="col col-12 mt-2 modificas__exeles__dis" id="visualizador__sueldos__y__salarios__con__desvinculaciones">
				...
				<table class="tabla__modificaciones__exeles"><thead><tr><th colspan="13"><a class="btn btn-warning" id="vuelvesSeleccionas__sueldos__desvinculaciones">Volver a seleccionar Archivo&nbsp;&nbsp;<i class="fa fa-reply" aria-hidden="true"></i></a></th><th colspan="13"><a class="btn btn-primary" id="guardar__sueldosSalarios__desvinculaciones">Guardar&nbsp;&nbsp;<i class="fa fa-floppy-o" aria-hidden="true"></i></a></th></tr><tr><th>Actividad</th><th>Cédula</th><th>Cargo</th><th>Nombres</th><th>Tipo Cargo</th><th>Tipo de desvinculación</th><th>Monto</th><th>Enero</th><th>Febrero</th><th>Marzo</th><th>Abril</th><th>Mayo</th><th>Junio</th><th>Julio</th><th>Agosto</th><th>Septiembre</th><th>Octubre</th><th>Noviembre</th><th>Diciembre</th><th>Total</th></tr></thead><tbody class="visualizador__sueldos__y__salarios__desvinculaciones"></tbody></table>
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreHonorarios" name="semestreHonorarios">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>		
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreMantenimiento" name="semestreMantenimiento">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>	
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreAdministrativas" name="semestreAdministrativas">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>					
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreActividad__3" name="semestreActividad__3">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>	
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreActividad__5" name="semestreActividad__5">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>	
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreActividad__6" name="semestreActividad__6">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>
		...
		<div class="row separador__objetos mt-4">
			...
			<div class="col col-2 mt-4 textos__titulos d d-flex">
				...
				<select id="semestreActividad__7" name="semestreActividad__7">
					<option value="primerSemestre">Primer Semestre</option>
					<option value="segundoSemestre">Segundo Semestre</option>
				</select>
