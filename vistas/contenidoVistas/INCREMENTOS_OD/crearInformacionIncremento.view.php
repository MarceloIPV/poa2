<style>
	.itemsEscogidosEliminar{
		display: none;
	}
	.itemsEscogidosEditar{
		display: none;
	}	
</style>
...
<div class="content-wrapper d d-flex flex-column align-items-center">
	...
	<form class="content__configuraciones row d d-flex flex-column align-items-center mt-4 formulario__preliminarEnvio">
		...
		<center><h3>Creación de Información Incrementos</h3></center>
		
		<?=$componentes__incrementos->getContenidoActividadesPoaIncrementos("tablaPoaInicial","<tr><th><center>Código actividad</center></th><th><center>Nombre actividad</center></th><th style='width:20%!important;'><center>Indicador</center></th><th style='width:5%!important;'><center>Planificación de indicadores</center></th><th class='columna__item' style='width:5%!important;'><center>Planificar Items</center></th><th class='columna__eliminar' style='width:15%!important;'><center>Eliminar Actividades</center></th></tr>","body__actividadesEs__incrementos__insertar");?>		
...
<script type="text/javascript" src="layout/scripts/js/incrementosDecrementos/incrementosCreacionInformacion.js?v=1.0.2"></script>
