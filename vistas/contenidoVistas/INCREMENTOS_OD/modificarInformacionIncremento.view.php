...
<?php $componentes__incrementos = new componentes__incrementos__v1(); ?>
...
<div class="content-wrapper d d-flex flex-column align-items-center">
	...
	<form class="content__configuraciones row d d-flex flex-column align-items-center mt-4 formulario__preliminarEnvio">
		...
		<center><h3>Modificación de Información Incrementos</h3></center>
		<?= $componentes__incrementos->getContenidoActividadesPoaIncrementos("tablaPoaInicial", "<tr><th><center>Código actividad</center></th><th style='width:15%!important;'><center>Nombre actividad</center></th><th style='width:20%!important;'><center>Indicador</center></th><th class='columna__matricez'><center>Matrices<br>(Seleccionar la matriz para INGRESAR / EDITAR información)</center></th></tr>", "body__actividades__incrementos__editar"); ?>
...
<?php foreach ($informacionSeleccionada as $clave => $valor) : ?>
	...
	<?= $componentes__incrementos->getModalMatricez__Incrementos("modalMatriz" . $informacionSeleccionada[$clave]['idActividades'], "formMatriz" . $informacionSeleccionada[$clave]['idActividades'], $informacionSeleccionada[$clave]['idActividades'] . ".-" . $informacionSeleccionada[$clave]['nombreActividades'], "tablaHead" . $informacionSeleccionada[$clave]['idActividades'], "cuerpoMatriz" . $informacionSeleccionada[$clave]['idActividades']); ?>
...
<?= $componentes__incrementos->get__eventos__ingresados__incrementos("modal__editarEventos"); ?>
...
<?= $componentes__incrementos->crear__Eventos__Incrementos("modalEventoIncremento") ?>
