                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" style="text-align: center;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>Elaboración y aprobación</td>
                                    <td>
                                        <div class="input" id="contenedorRegistro">

                                            <a href="../manuales/Manual de usuario Elaboración y Aprobación de POA.pdf" class="manual" target="_blank">
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>Modificación parte 1</td>
                                    <td>
                                        <div class="input" id="contenedorRegistro">

                                            <a href="../manuales/Manual del usuario POA modificaciones parte 1 2023.pdf" class="manual" target="_blank">
                                                <i class="fa fa-book iconos_blancos"></i>
                                                &nbsp;&nbsp;
                                                Manual
                                            </a>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td>Modificación parte 2</td>
                                    <td>
                                        <div class="input" id="contenedorRegistro">

                                            <a href="../manuales/Manual del usuario POA modificaciones parte 2 2023.pdf" class="manual" target="_blank">
                                                <i class="fa fa-book iconos_blancos"></i>
                                                &nbsp;&nbsp;
                                                Manual
                                            </a>
                                ...
                                <tr>
                                    ...
                                    <td>4</td>
                                    <td>Modificación parte 3</td>
                                    <td>
                                        <div class="input" id="contenedorRegistro">

                                            <a href="../manuales/Manual del usuario POA modificaciones parte 3 2023.pdf" class="manual" target="_blank">
                                                <i class="fa fa-book iconos_blancos"></i>
                                                &nbsp;&nbsp;
                                                Manual
                                            </a>
                                ...
                                <tr>
                                    ...
                                    <td>5</td>
                                    <td>Seguimiento parte 1</td>
                                    <td>
                                        <div class="input" id="contenedorRegistro">

                                            <a href="../manuales/Manual del usuario POA seguimiento parte 1.pdf" class="manual" target="_blank">
                                                <i class="fa fa-book iconos_blancos"></i>
                                                &nbsp;&nbsp;
                                                Manual
                                            </a>
                                ...
                                <tr>
                                    ...
                                    <td>6</td>
                                    <td>Seguimiento parte 2</td>
                                    <td>
                                        <div class="input" id="contenedorRegistro">

                                            <a href="../manuales/Manual del usuario POA seguimiento parte 2.pdf" class="manual" target="_blank">
                                                <i class="fa fa-book iconos_blancos"></i>
                                                &nbsp;&nbsp;
                                                Manual
                                            </a>
                               ...
                               <tr>
                                    ...
                                    <td>7</td>
                                    <td>Seguimiento parte 3</td>
                                    <td>
                                        <div class="input" id="contenedorRegistro">

                                            <a href="../manuales/Manual del usuario POA seguimiento parte 3.pdf" class="manual" target="_blank">
                                                <i class="fa fa-book iconos_blancos"></i>
                                                &nbsp;&nbsp;
                                                Manual
                                            </a>
